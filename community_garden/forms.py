...
class RegisterForm( FlaskForm ):
    ...
    username = StringField( label='username', validators=[Length(max=65), Email(), DataRequired()])
    email = StringField( label='email', validators=[Length(min=3, max=65), DataRequired()])
